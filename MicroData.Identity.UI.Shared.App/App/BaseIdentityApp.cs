...
{
    public abstract class BaseIdentityApp<T,M> : IBaseApi<T> where T : IBaseViewModel where M:IBaseModel
    {
        private readonly IBaseService<M> _baseService;
        private readonly IMapper _mapper;
        public BaseIdentityApp(IBaseService<M> baseService, IMapper mapper)
        {
